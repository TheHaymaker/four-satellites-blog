...
- Build relationship(s) with non-profit(s) &#10006;
  ...
  - establish a reoccuring retainer for 10-20/hrs/month &#10006;
...
Thats `40hrs + 6hrs of classtime + 2hrs of office hours + 3hrs of prep + 3 hrs of grading = 54 hours/week` minimum.
...
You have a point. It's a good problem to have. To have _too_ much work. And I am privileged and lucky to be in that position, especially with the nature of the work itself. I completely acknowlege that.
...
While I was able to achieve some of my goals, the goals I set out to achieve - such as establish a relationship with a non-profit, or obtain the title of JavaScript Engineer, or publishiing my poetry manuscript from graduate school were possible - but not likely due to the costs exerted by the realization of my other goals.
